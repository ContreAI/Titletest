...
import { green, spruce } from 'theme/palette/colors';
  ...
  return (
    <div>
      ...
      >
        <Toolbar
          sx={(theme) => ({
            background: `linear-gradient(90.42deg, ${spruce[300]} 13.1%, ${green[400]} 143.31%)`,
            gap: 1,

            ...theme.applyStyles('dark', {
              background: `linear-gradient(90.42deg, ${spruce[900]} 13.1%, ${green[600]} 143.31%)`,
            }),
          })}
        >
          <Typography
