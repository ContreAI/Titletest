...
// Type assertion needed due to MUI's strict variant typing with CSS vars
...
) as NonNullable<ComponentsVariants['MuiPaginationItem']>;
        ...
        variants: [
          {
            ...
            style: (props: PaginationProps & VariantStyleProps) => {
              const { color } = props;
