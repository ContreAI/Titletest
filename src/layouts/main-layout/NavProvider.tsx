...
const NavProvider = ({ children }: PropsWithChildren) => {
  ...
  // Initialize loaded as true - the useEffect will handle config updates
  // but we shouldn't block rendering waiting for it
  ...
  }, [currentBreakpoint, navigationMenuType, downMd, sidenavType, sidenavCollapsed, configDispatch, setConfig, loaded]);
